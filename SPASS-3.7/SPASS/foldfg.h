...
static __inline__ SYMBOL fol_Xor(void)
{
  return fol_XOR;
}

static __inline__ SYMBOL fol_Nor(void)
{
  return fol_NOR;
}

static __inline__ SYMBOL fol_Nand(void)
{
  return fol_NAND;
}
...
static __inline__ SYMBOL fol_NonEquality(void)
{
